    ...
    render() {
        return (
            <PageBody><PageParagraphText><ContactSection>
                ...
                <ContactDiv><DetailHeader>Contact Charlottesvino</DetailHeader>
                    <DetailText>
